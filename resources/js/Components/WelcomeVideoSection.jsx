...
export default function WelcomeVideoSection() {
    return (
        <section className="py-14 sm:py-20 bg-white dark:bg-black transition-colors duration-300 relative overflow-hidden border-b border-slate-200/80 dark:border-zinc-900">
            ...
            <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[720px] h-[360px] bg-sky-500/5 rounded-full blur-3xl pointer-events-none" />

            <div className="container-content relative z-10 mb-8 sm:mb-12 text-center">
                {/* Corporate Badge */}
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/25 text-sky-600 dark:text-sky-400 font-mono text-xs tracking-wider uppercase font-semibold mb-3">
                ...
                <div className="max-w-4xl mx-auto">
                    <AnimatedHeading
                        ...
                        gradientClass="bg-gradient-to-r from-sky-600 via-blue-600 to-cyan-500 dark:from-sky-400 dark:via-blue-300 dark:to-cyan-300 bg-clip-text text-transparent"
                    >
            ...
            <div className="container-content relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="group relative rounded-2xl overflow-hidden border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-950 shadow-md hover:border-sky-500/50 transition-all duration-300">
                        ...
                        <div className="p-6">
                            <span className="text-xs font-mono font-semibold text-sky-600 dark:text-sky-400 uppercase tracking-wider">Delhi Manufacturing Plant</span>
                    ...
                    <div className="group relative rounded-2xl overflow-hidden border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-950 shadow-md hover:border-sky-500/50 transition-all duration-300">
                        ...
                        <div className="p-6">
                            <span className="text-xs font-mono font-semibold text-sky-600 dark:text-sky-400 uppercase tracking-wider">NOC & IoT Automation</span>
                    ...
                    <div className="group relative rounded-2xl overflow-hidden border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-950 shadow-md hover:border-sky-500/50 transition-all duration-300">
                        ...
                        <div className="p-6">
                            <span className="text-xs font-mono font-semibold text-sky-600 dark:text-sky-400 uppercase tracking-wider">Power Engineering</span>
                ...
                <div className="mt-8 text-center">
                    <Link
                        href="/about-us"
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-sky-600 hover:bg-sky-500 text-white font-semibold text-sm shadow-md transition-all"
                    >
