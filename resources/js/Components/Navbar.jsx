            ...
            {mobileOpen && (
                <div className="lg:hidden bg-white dark:bg-navy border-b border-slate-200 dark:border-navy-border shadow-2xl px-6 py-6 space-y-4 animate-in fade-in slide-in-from-top-4 duration-200">
                    ...
                    <div className="pt-4 border-t border-slate-200 dark:border-white/10 space-y-3">
                        <div>
                            <span className="block text-[11px] font-mono uppercase tracking-wider text-slate-500 dark:text-steel mb-2">
                            ...
                            <div className="flex items-center gap-3">
                                <a
                                    ...
                                    className="w-8 h-8 rounded-lg bg-[#1877F2] text-white flex items-center justify-center text-xs font-bold"
                                    aria-label="Facebook"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-8 h-8 rounded-lg bg-black text-white flex items-center justify-center text-xs font-bold"
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-8 h-8 rounded-lg bg-[#0A66C2] text-white flex items-center justify-center text-xs font-bold"
                                    aria-label="LinkedIn"
                                >
                                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="text-xs font-mono text-slate-500 dark:text-steel space-y-1">
                            ...
                            <div>Email: sales@sysinfra.in</div>
                        </div>
                    </div>
                </div>
            )}
